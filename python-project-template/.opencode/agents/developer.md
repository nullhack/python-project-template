---
description: Specialized development agent for Python Project Template - handles code implementation, debugging, and feature development
mode: subagent
...
4. Validate coverage meets 100%: `task test`
