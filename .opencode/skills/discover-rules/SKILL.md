...
3. If an invariant has no corresponding Rule, add it as a Rule block with a behavioral description derived from the invariant. Format: `Rule: <3-8 word title>` followed by a behavioral description paragraph.
