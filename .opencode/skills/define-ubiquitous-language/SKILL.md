...
description: "Extract domain terms from the domain spec and interview notes, define them in genus-differentia format, and cross-reference"
---
...
1. Read `domain_spec.md` and all interview notes. If `glossary.md` already exists, read it for cumulative editing.
...
6. Cross-reference per [[requirements/ubiquitous-language#content]]: verify glossary → domain spec, domain spec → glossary, glossary → feature files. Flag any gaps.
