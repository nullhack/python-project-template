---
name: map-contexts
description: "Map bounded context relationships, Vernon patterns, and anti-corruption layers into domain_spec.md integration points"
---
...
4. Write the Context Map section into domain_spec.md (context relationships table, diagram, ACL table).
5. Update the Integration Points section in domain_spec.md with the context-to-context communication details (purpose, trigger, payload, response).
