...
Available knowledge: [[software-craft/tdd#key-takeaways]]. `in` artifacts: read all before starting work.
...
9. Commit to the feature branch per [[software-craft/git-conventions#content]].
