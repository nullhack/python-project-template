...
| Delayed refactoring | Obsolete code has more dependent code built on it | Refactor continuously |
...
| Adding a feature to messy code | Refactor first, then add feature (prepared refactoring) | [[software-craft/tdd#concepts]] (refactoring) |
...
- [[software-craft/tdd]]: refactoring is an integral part of TDD
