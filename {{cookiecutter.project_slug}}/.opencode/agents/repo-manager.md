...
1. Analyze PR titles/descriptions from last release
2. Determine overall "vibe" (performance, security, features, fixes, etc.)
3. Select appropriate adjective + animal combination

**Example Theme Mapping:**
- **Performance PRs**: `swift cheetah`, `lightning falcon`, `rapid hare`
- **Security PRs**: `vigilant owl`, `guardian bear`, `watchful hawk`
- **Feature PRs**: `creative fox`, `innovative dolphin`, `clever raven`
