...
This file tracks current feature development. For full feature list, see docs/roadmap.md and docs/features/backlog/.
...
- [ ] Create first feature in docs/features/backlog/
...
- [ ] Move feature to docs/features/completed/ when done
